...
Ship = function () {
    ...
    this.children.exhaust.fillColor = "#FFCE47";
    this.children.exhaust.strokeColor = "#FFBC47";
...
Asteroid = function () {
    ...
    this.fillColor = "#EBEBEB";
    this.strokeColor = "#D1D1D1";
...
function gotStartMatch(params) {
    ...
    Game.ship.fillColor = Game.ship.strokeColor = colorMap[playerColors[yourPlayerIndex]];
    Game.FSM.state = 'countdown';
}
